...
  onEmployeeSelect: (event: any, value: any) => void;
  ...
  /**
   * On employee input change callback for autocomplete.
   */
  onEmployeeInputChange: (event: React.ChangeEvent<{}>, newInputValue: string) => void;
}
...
    onTimeChange,
    onEmployeeSelect,
    onEmployeeInputChange // Destructure the new prop
  } = props;
  
...
                        onChange={onEmployeeSelect}
                        onInputChange={onEmployeeInputChange} // Added new prop
                        onOpen={() => {
